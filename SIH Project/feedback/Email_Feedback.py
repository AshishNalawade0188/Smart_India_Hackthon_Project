...
receiver_email = "ashishnalawade683@gmail.com","shivaniborhade9@gmail.com"
...
# Schedule the email for 7 days later
def schedule_email():
...
if __name__ == "__main__":
    print("Scheduling the email to be sent in 7 days...")
    schedule.every(7).days.do(schedule_email)
